...
export class ProductDetailComponent implements OnInit {
  ...
  orderPlaced: boolean
  orders = [];
  constructor(@Inject(MAT_DIALOG_DATA) public data: Product, public dialog: MatDialog, private basketService: BasketService, private productsService: ProductsService, private authService: AuthService, public dialogRef: MatDialogRef<ProductDetailComponent>, private router: Router, private route: ActivatedRoute) {
    this.product = data;
  ...
  submitOpinion() {//TODO add opinion to firebase
   (<HTMLInputElement>document.getElementById('opinionTextArea')).value = "";
...
@Component({
  ...
  template: `
            ...
            <div mat-dialog-actions>
                <button mat-raised-button color="accent" (click)="closeClick()">Close</button>
            </div>
          `
})
export class DialogOpinion {
  constructor(
    public dialogRef: MatDialogRef<DialogOpinion>) { }
